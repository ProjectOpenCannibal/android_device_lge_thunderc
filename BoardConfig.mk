...
ifeq ($(SUB_MODEL),LS670)
    ...
    ## COT ##
    BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/lge/thunderc/recovery/recovery_ui_ls670.c
endif
...
ifeq ($(SUB_MODEL),VM670)
    ...
    ## COT ##
    BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/lge/thunderc/recovery/recovery_ui_vm670.c
endif
...
ifeq ($(SUB_MODEL),MS690)
    ...
    ## COT ##
    BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/lge/thunderc/recovery/recovery_ui_ms690.c
endif
